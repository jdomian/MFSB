...
camera = PiCamera(sensor_mode=2, resolution='640x480', framerate=30)
...
tfscriptJs = getFile('tfscript.js')
...
class tfscriptHandler(tornado.web.RequestHandler):
    def get(self):
        self.set_header('Content-Type', 'text/javascript')
        self.write(tfscriptJs)
